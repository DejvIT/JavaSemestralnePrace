 ...
 * ktoré následne budú tvoriť objekty na bojovom poli ktoré budú brániť
 * hráčovi v pohybe.
 * 
...
public class TehlyCasti {
    ...
    public TehlyCasti() {
        ...
        /** Dve tehly, ktoré sú vo vnútri steny. */
