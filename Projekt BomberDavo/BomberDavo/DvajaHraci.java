...
public class DvajaHraci {
    ...
    public void tik() { 
        if (this.stav == StavHry.NEROZHODNUTA) {
            this.pocitadloHrac1++;
            if (this.pocitadloHrac1 == 8) { //  výbuch nastane po 2 sekundách
            ...
            if (this.pocitadloHrac1 == 9) { // výbuch zotrváva štvrť sekundy
            ...
            this.pocitadloHrac2++;
            if (this.pocitadloHrac2 == 8) { //  výbuch nastane po 2 sekundách
            ...
            if (this.pocitadloHrac2 == 9) { // výbuch zotrváva štvrť sekundy
    ...
    /**
     * Ak na bojisku padne jeden alebo obaja atentátnici, vypíše kto vyhral.
     */
    public void getKoniecHry() {
        if (this.stav != StavHry.NEROZHODNUTA) {
            if (this.stav == StavHry.REMIZA) {
                ...
                JOptionPane.showMessageDialog(null, "Túto bitku vyhral Prvý hráč s farbou: " + this.farbaPrvehoHraca);
            } else {
                JOptionPane.showMessageDialog(null, "Túto bitku vyhral Druhý hráč s farbou: " + this.farbaDruhehoHraca);
            }
        }
    }
