...
public class Manazer {
    ...
    private class ManazerKlaves extends KeyAdapter {
        public void keyPressed(KeyEvent event) {
            if (event.getKeyCode() == KeyEvent.VK_DOWN) {
            ...
            } else if (event.getKeyCode() == KeyEvent.VK_ENTER) { /** Úprava kvôli Bombermanovi, aby hráč nedával bomby medzerníkom a zaroveň aj enterom */
                ...
                /** Dodatočné úpravy pre hru Bomberman */ 
