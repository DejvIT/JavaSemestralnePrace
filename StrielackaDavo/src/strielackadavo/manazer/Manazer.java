package strielackadavo.manazer;

import strielackadavo.grafika.Platno;
...
public class Manazer {
    ...
    private class ManazerKlaves extends KeyAdapter {
        public void keyPressed(KeyEvent event) {
            ...
            } else if (event.getKeyCode() == KeyEvent.VK_ENTER) { /** Úprava kvôli semestrálke aby enter a medzernik neboli synchornné */
                Manazer.this.posliSpravu("aktivuj");
            } else if (event.getKeyCode() == KeyEvent.VK_ESCAPE) {
                Manazer.this.posliSpravu("zrus");
                
                /** Dodatočné úpravy pre semestrálku */ 
            } else if (event.getKeyCode() == KeyEvent.VK_S) { 
                Manazer.this.posliSpravu("posunDole2");
            } else if (event.getKeyCode() == KeyEvent.VK_W) {
                Manazer.this.posliSpravu("posunHore2");
            } else if (event.getKeyCode() == KeyEvent.VK_A) {
                Manazer.this.posliSpravu("posunVLavo2");
            } else if (event.getKeyCode() == KeyEvent.VK_D) {
                Manazer.this.posliSpravu("posunVpravo2"); 
            } else if (event.getKeyCode() == KeyEvent.VK_SPACE) {
                Manazer.this.posliSpravu("aktivuj2"); 
            } else if (event.getKeyCode() == KeyEvent.VK_9) {
                Manazer.this.posliSpravu("cheat1"); 
            } else if (event.getKeyCode() == KeyEvent.VK_6) {
                Manazer.this.posliSpravu("cheat2"); 
            }
        }
    }
