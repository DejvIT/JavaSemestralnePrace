...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("BlueJ Shapes Demo", 1000, 1000, /** Zmena veľkosti plátna kvôli semestrálke */
                                         Color.white);
        }
    ...
    public void setForegroundColor(String farba) {
        ...
        } else if (farba.equals("grey")) {
            this.graphic.setColor(new Color(128, 128, 128));
        } else if (farba.equals("brown")) {
            this.graphic.setColor(new Color(150, 75, 0));
        } else {
            this.graphic.setColor(Color.black);
        }
    }
